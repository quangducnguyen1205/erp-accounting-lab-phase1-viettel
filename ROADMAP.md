...
| Observability: Prometheus/Grafana/Loki | Important mini-lab/note | `docs/07-architecture/observability-prometheus-grafana-loki.md` | Actuator/log/metric pattern, optional stack | Explain metric/log/tracing role | #16 | Planned |
