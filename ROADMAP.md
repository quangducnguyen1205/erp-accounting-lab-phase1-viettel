...
| Observability mini-lab | `docs/07-architecture/observability-foundation.md`, `docs/07-architecture/logging-metrics-tracing.md`, `docs/07-architecture/spring-boot-actuator-code-guide.md`, `docs/07-architecture/observability-mini-lab-plan.md` |
...
2. Sau đó bắt đầu Milestone #16 theo workflow cũ:
   - đọc foundation docs cho logs/metrics/health/tracing;
   - tự code Actuator/Micrometer skeleton nhỏ theo `spring-boot-actuator-code-guide.md`;
   - chỉ làm health/info/metrics + log/metric nhỏ, không dựng full Grafana/Loki nếu chưa cần.
