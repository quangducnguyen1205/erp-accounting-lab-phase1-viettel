...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/files", "/api/files/**")
                        .hasAnyRole("ADMIN", "ACCOUNTANT")
                        .requestMatchers(HttpMethod.DELETE, "/api/files", "/api/files/**")
                        .hasAnyRole("ADMIN", "ACCOUNTANT")
    ...
    @Bean
    JwtAuthenticationConverter jwtAuthenticationConverter(FileSecurityProperties securityProperties) {
        return JwtAuthenticationConverters.withDefaultScopesAndKeycloakRoles(securityProperties.getClientId());
    }

    @Bean
    JwtDecoder jwtDecoder(FileSecurityProperties securityProperties) {
